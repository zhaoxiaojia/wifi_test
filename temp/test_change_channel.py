...
passwd = '12345678'
router_ch1 = Router(band='2.4G', ssid=ssid, wireless_mode='N only', channel='1', bandwidth='40 MHz',
                    authentication='WPA2-Personal', wpa_passwd=passwd)
router_ch6 = Router(band='2.4G', ssid=ssid, wireless_mode='N only', channel='6', bandwidth='40 MHz',
                    authentication='WPA2-Personal', wpa_passwd=passwd)
router_ch11 = Router(band='2.4G', ssid=ssid, wireless_mode='N only', channel='11', bandwidth='40 MHz',
                     authentication='WPA2-Personal', wpa_passwd=passwd)
