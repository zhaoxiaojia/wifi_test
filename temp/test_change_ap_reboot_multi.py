...
router_40 = Router(band='2.4G', ssid=ssid, wireless_mode='N only', channel='6', bandwidth='40 MHz',
                   authentication='WPA2-Personal', wpa_passwd=passwd)
router_mix = Router(band='2.4G', ssid=ssid, wireless_mode='Legacy', channel='11', bandwidth='20/40 MHz',
                   authentication='WPA2-Personal', wpa_passwd=passwd)
