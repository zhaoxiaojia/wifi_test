...
# @Author  : chao.li
# @Site    :
# @File    : test_Wifi_hide_ssid_wep128.py
# @Software: PyCharm
...
passwd = 'Abc1234567'
router_5g = Router(band='5G', ssid=ssid, wireless_mode='Legacy', channel='157', bandwidth='20 MHz',
                   authentication='Shared Key', wep_passwd=passwd, wep_encrypt='WEP-128bits', passwd_index='1',hide_ssid='是')
