...
# @Time    : 2023/4/14 14:21
# @Author  : chao.li
# @Site    :
# @File    : test_Wifi_11ac_channel_44.py
# @Software: PyCharm
...
'''
测试配置
11ac mode 信道44 40MHz带宽

Connect an AP which channel is 5G ac44-band 40
'''

ssid = 'ATC_ASUS_AX88U_5G'
passwd = 'Abc@123456'
router_5g = Router(band='5G', ssid=ssid, wireless_mode='N/AC/AX mixed', channel='44', bandwidth='40 MHz',
