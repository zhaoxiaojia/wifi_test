...
# @Time    : 2023/4/28 11:02
# @Author  : chao.li
# @Site    :
# @File    : test_Wifi_11ax_channel_44_40mhz.py
# @Software: PyCharm
...
'''
测试配置
11ax mode 信道44 40MHz带宽

Connect an AP which channel is 5G AX-44-band 40
...
passwd = 'Abc@123456'
router_5g = Router(band='5G', ssid=ssid, wireless_mode='AX only', channel='44', bandwidth='40 MHz',
