...
# @Author  : chao.li
# @Site    :
# @File    : test_Wifi_11ac_channel_132.py
# @Software: PyCharm
...
'''
测试配置
11ac mode 信道132 40MHz带宽

Connect an AP which channel is 5G ac40-band 132
'''

ssid = 'ATC_ASUS_AX88U_5G'
passwd = 'Abc@123456'
router_5g = Router(band='5G', ssid=ssid, wireless_mode='N/AC/AX mixed', channel='132', bandwidth='40 MHz',
