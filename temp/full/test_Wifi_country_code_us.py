...
router_us = Router(band='2.4G', ssid=ssid, wireless_mode='N only', channel='1', bandwidth='40 MHz',
                   authentication='Open System')
router_cn = Router(band='2.4G', ssid=ssid, wireless_mode='N only', channel='13', bandwidth='40 MHz',
                   authentication='Open System')
