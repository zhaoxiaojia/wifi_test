# !/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2023/5/16 09:58
# @Author  : Chao.li
# @File    : test_Wifi_connect_sharekey_wep_128bit_hex.py
# @Project : python
# @Software: PyCharm
...
'''
测试配置
ShareKey WEP 128bit hex

Connect an AP which authentication method is WEP & Certification Type:ShareKey   & 128bit &Hex

Platform connect the AP successful
'''

ssid = 'ATC_ASUS_AX88U_2G'
passwd = '0123456789012'
router_2g = Router(band='2.4G', ssid=ssid, wireless_mode='Legacy', channel='1', bandwidth='20 MHz',
                   authentication='Shared Key', wep_passwd=passwd,wep_encrypt='WEP-128bits')
