...
# @Time    : 2023/4/28 13:39
# @Author  : chao.li
# @Site    :
# @File    : test_Wifi_11ac_channel_149.py
# @Software: PyCharm
...
测试配置
11ac mode 信道149
Connect an AP which channel is 5G AC-149
Platform connect the AP successful
'''

ssid = 'ATC_ASUS_AX88U_5G'
passwd = 'Abc@123456'
router_5g = Router(band='5G', ssid=ssid, wireless_mode='N/AC/AX mixed', channel='149', bandwidth='40 MHz',
