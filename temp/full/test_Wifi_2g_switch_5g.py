...
import time
from src.test import (Router, connect_save_ssid, connect_ssid, forget_network_cmd,
                      kill_setting, playback_youtube, wifi)
...
passwd = '12345678'
router_2g = Router(band='2.4G', ssid='ATC_ASUS_AX88U_2G', wireless_mode='自动', channel='自动', bandwidth='20 MHz',
                   authentication='WPA2-Personal', wpa_passwd=passwd)
router_5g = Router(serial='1', band='5G', ssid='XiaomiAX3000_5G', channel='自动',
