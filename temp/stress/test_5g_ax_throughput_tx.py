...
router_5g = Router(band='5G', ssid=ssid, wireless_mode='11ax', channel='36', bandwidth='40 MHz',
...
@multi_stress
def test_5g_throughtput_tx(device):
    ...
    get_tx_rate(pc_ip, dut_ip, router_5g, 4, "", "", "TCP")
