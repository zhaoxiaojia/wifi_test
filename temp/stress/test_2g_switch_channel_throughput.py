...
router_ch1 = Router(band='2.4G', ssid=ssid, wireless_mode='11ax', channel='1', bandwidth='40 MHz',
                    authentication='Open System')
router_ch6 = Router(band='2.4G', ssid=ssid, wireless_mode='11ax', channel='6', bandwidth='40 MHz',
                    authentication='Open System')
router_ch11 = Router(band='2.4G', ssid=ssid, wireless_mode='11ax', channel='11', bandwidth='40 MHz',
                     authentication='Open System')
