...
router_2g = Router(band='2.4G', ssid=ssid, wireless_mode='Legacy', channel='自动', bandwidth='20 MHz',
                   authentication='Shared Key', wep_encrypt='WEP-128bits', wep_passwd='1234567890123')
