...
# -*- coding: utf-8 -*- 
"""
# File       : test_52_connect_5g_wpa2_aes_no_pmf.py
# Time       ：2023/7/14 16:57
# Author     ：chao.li
# version    ：python 3.9
# Description：
"""
...
'''
测试配置
1.设置路由器2.4G 无线网络名称为“ATC_ASUS_AX88U_5G”，隐藏SSID设置为否，无线模式设置为自动，频道带宽设置为20/40/80 M,信道设置为149，授权方式为WPA2-Personal,WPA加密选择AES，WPA-PSK无线密码设置为Abc@$123456,受保护的管理帧设置为禁用
2.连接2.4G SSID
...
router_5g = Router(band='5 GHz', ssid=ssid, wireless_mode='自动', channel='149', bandwidth='20/40/80 MHz',
                   authentication='WPA2-Personal', wpa_passwd=passwd, protect_frame='停用', wpa_encrypt='AES')
