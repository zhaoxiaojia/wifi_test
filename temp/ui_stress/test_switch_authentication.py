...
passwd = '12345678'
router_open = Router(band='5G', ssid=ssid, wireless_mode='N/AC/AX mixed', channel='36', bandwidth='40 MHz',
                     authentication='Open System')
router_legacy = Router(band='5G', ssid=ssid, wireless_mode='Legacy', channel='40', bandwidth='20 MHz',
                       authentication='WPA2-Personal', wpa_passwd=passwd)
router_auto = Router(band='5G', ssid=ssid, wireless_mode='自动', channel='44', bandwidth='40 MHz',
                     authentication='WPA2-Personal', wpa_passwd=passwd)
