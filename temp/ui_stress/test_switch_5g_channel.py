...
passwd = '12345678'
router_ch36 = Router(band='5G', ssid=ssid, wireless_mode='N/AC/AX mixed', channel='36', bandwidth='20 MHz',
                     authentication='WPA2-Personal', wpa_passwd=passwd)
router_ch48 = Router(band='5G', ssid=ssid, wireless_mode='N/AC/AX mixed', channel='48', bandwidth='20 MHz',
                     authentication='WPA2-Personal', wpa_passwd=passwd)
router_ch149 = Router(band='5G', ssid=ssid, wireless_mode='N/AC/AX mixed', channel='149', bandwidth='20 MHz',
                      authentication='WPA2-Personal', wpa_passwd=passwd)
