...
router_ch1 = Router(band='2.4 GHz', ssid=ssid, wireless_mode='AX only', channel='1', bandwidth='40 MHz',
                    authentication_method='Open System')
router_ch6 = Router(band='2.4 GHz', ssid=ssid, wireless_mode='AX only', channel='6', bandwidth='40 MHz',
                    authentication_method='Open System')
router_ch11 = Router(band='2.4 GHz', ssid=ssid, wireless_mode='AX only', channel='11', bandwidth='40 MHz',
                     authentication_method='Open System')
