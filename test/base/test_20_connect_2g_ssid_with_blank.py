...
# -*- coding: utf-8 -*- 
"""
# File       : test_20_connect_2g_ssid_with_blank.py
# Time       ：2023/7/14 10:47
# Author     ：chao.li
# version    ：python 3.9
# Description：
"""
...
测试步骤
1.设置路由器2.4G 无线网络名称为
“test 12345”(包含空格)，隐藏SSID设置为否，无线模式设置为自动，频道带宽设置为20/40M,信道设置为自动，授权方式为open
2.连接2.4G SSID
...
def test_connect_ssid_with_blank():
