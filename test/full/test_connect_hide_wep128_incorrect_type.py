...
"""
# File       : test_connect_hide_wep128_incorrect_type.py
# Time       ：2023/8/1 16:47
# Author     ：chao.li
# version    ：python 3.9
# Description：
...
router_2g = Router(band='2.4 GHz', ssid=ssid, wireless_mode='自动', channel='1', bandwidth='20/40 MHz',
                   authentication_method='WPA/WPA2-Personal', wpa_passwd=passwd, hide_ssid='是')
...
def test_connect_wep128_wrong_type():
    try:
