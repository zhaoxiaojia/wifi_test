...
# @Time    : 2023/4/25 11:08
# @Author  : chao.li
# @Site    :
# @File    : test_Wifi_5g_auto.py
# @Software: PyCharm
...
Connect an AP which wireless mode is 802.11 Auto-5G
...
passwd = 'Abc@123456'
router_5g = Router(band='5 GHz', ssid=ssid, wireless_mode='自动', channel='44', bandwidth='40 MHz',
