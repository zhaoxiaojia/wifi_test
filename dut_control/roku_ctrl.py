...
class RokuCtrl(Roku, Ir):
	...
	def get_display_info(self):
		...
		# width = pytest.dut.checkoutput(Common.show_video_width)
		# height = pytest.dut.checkoutput(Common.show_video_height)
		# frame = pytest.dut.checkoutput(Common.show_frame_decoded)
		# frame_rate = pytest.dut.checkoutput(Common.show_frame_rate)
