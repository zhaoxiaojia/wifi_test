...
class roku_wpa:
    ...
    def wait_for_state(self, iface='wlan0', target_state='COMPLETED', timeout=30, interval=2):
        """
    ...
    def connect(self, ssid, auth_type="WPA2-PSK", psk=None, eap=None, identity=None, password=None,
                ...
                max_retry=3, wait_connect=5, state_timeout=30, retry_interval=2):
        """
        ...
        for attempt in range(1, max_retry + 1):
            ...
            self.start_wpa_supplicant(iface=iface)
