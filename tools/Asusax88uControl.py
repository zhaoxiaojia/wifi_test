...
# router = Router(band='2.4 GHz', ssid='超超真帅', wireless_mode='Legacy', channel='自动', bandwidth='20 MHz',
#                 authentication_method='WPA2-Personal', wpa_passwd='12345678', country_code='美国')
