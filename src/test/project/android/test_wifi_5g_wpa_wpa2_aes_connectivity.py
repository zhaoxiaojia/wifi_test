# test_wifi_5g_wpa_wpa2_aes_connectivity.py
"""
...
TCID = "WiFi-STA-FSM00212"
PASSWORD = "88888888"  # 10-digit hex key for WEP-64


@allure.title("Wi-Fi 5G WPA_WPA2-PSK&AES Connectivity Test")
@allure.description("""
1. Configure Wi-Fi 5G with WPA_WPA2-PSK&AES  encryption on router.
...
""")
def test_wifi_5g_wpa_wpa2_aes_connectivity(wifi_adb_device):
