# test_wifi_24g_wpa2_wpa3_sae_connectivity.py
"""
...
TCID = "WiFi-STA-FSM00261"
PASSWORD = "88888888"  # 10-digit hex key for WEP-64


@allure.title("Wi-Fi 2.4G WPA2_WPA3-SAE Connectivity Test")
@allure.description("""
1. Configure Wi-Fi 2.4G with WPA2_WPA3-SAE encryption on router.
