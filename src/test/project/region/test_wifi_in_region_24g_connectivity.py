# test_wifi_asia_region_24g_connectivity.py
import pytest
import allure
import time
import logging
...
@allure.title("Wi-Fi ASIA Region and 2.4G Channel Connectivity Test")
@allure.description("""
...
""")
def test_wifi_asia_region_24g_connectivity(wifi_adb_device):
    ...
    try:
        ...
        with allure.step("Configure AP to ASIA Region"):
            try:
                ...
                record_test_step(TCID, f"AP ASIA Region ", "PASS", ap_channel_list)
