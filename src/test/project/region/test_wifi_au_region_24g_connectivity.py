...
@allure.title("Wi-Fi Australia Region and 2.4G Channel Connectivity Test")
@allure.description("""
...
""")
def test_wifi_au_region_24g_connectivity(wifi_adb_device):
