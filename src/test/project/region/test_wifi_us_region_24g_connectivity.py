...
@allure.title("Wi-Fi USA Region and 2.4G Channel Connectivity Test")
@allure.description("""
...
""")
def test_wifi_us_region_connectivity(wifi_adb_device):
    ...
    try:
        ...
        with allure.step("Configure AP to USA Region"):
            ...
            with allure.step("Connect DUT to initial auto (2.4G) network"):
                ...
                record_test_step(TCID, f"Initial connect to {ssid_2g} (CH Auto) use country code {country})",
