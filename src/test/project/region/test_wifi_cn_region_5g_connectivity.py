# test_wifi_cn_region_5g_connectivity.py
import pytest
import allure
import time
import logging
...
# 请替换为你的实际 TCID
TCID = "WiFi-STA-REG0004"

TEST_CHANNELS_2G = [1, 6, 11]
TEST_CHANNELS_5G = [36, 64, 165]
MAX_WAIT_TIME = 180

@allure.title("Wi-Fi China Region and 5G Channel Connectivity Test")
@allure.description("""
...
""")
def test_wifi_cn_region_5g_connectivity(wifi_adb_device):
