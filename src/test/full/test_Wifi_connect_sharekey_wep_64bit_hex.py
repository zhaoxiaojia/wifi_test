# !/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2023/5/16 09:43
# @Author  : Chao.li
# @File    : test_Wifi_connect_sharekey_wep_64bit_hex.py
# @Project : python
# @Software: PyCharm
...
'''
测试配置
ShareKey WEP 64bit hex

Connect an AP which authentication method is WEP &Certification Type:ShareKey & 64bit &Hex
