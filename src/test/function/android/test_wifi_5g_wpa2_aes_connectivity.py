# test_wifi_5g_wpa2_aes_connectivity.py
"""
...
TCID = "WiFi-STA-FSM00182"
PASSWORD = "88888888"  # 10-digit hex key for WEP-64


@allure.title("Wi-Fi 5G WPA2-PSK &AES Connectivity Test")
@allure.description("""
1. Configure Wi-Fi 5G with WPA2-PSK &AES  encryption on router.
2. Connect DUT to the WPA2 network via UI with the correct password.
3. Verify internet connectivity by playing an online video.
""")
def test_wifi_wpa2_aes_connectivity(wifi_adb_device):
