# test_wifi_5g_wpa_wpa2_tkip_connectivity.py
"""
...
TCID = "WiFi-STA-FSM0019"
PASSWORD = "88888888"


@allure.title("Wi-Fi 5G WPA_WPA2-PSK&AES+TKIP Connectivity Test")
@allure.description("""
1. Configure Wi-Fi 5G with WPA_WPA2-PSK&AES+TKIP  encryption on router.
...
""")
def test_wifi_5g_wpa_wpa2_tkip_connectivity(wifi_adb_device):
