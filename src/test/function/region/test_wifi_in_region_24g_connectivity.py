# test_wifi_in_region_24g_connectivity.py
import pytest
import allure
import time, os
import logging
...
# 请替换为你的实际 TCID
TCID = "WiFi-STA-REG0007"

TEST_CHANNELS_2G = [1, 6, 11, 13]
TEST_CHANNELS_5G = [36, 64, 144, 165]
MAX_WAIT_TIME = 500
TEST_REGION_CODE = "IN"
TEST_REGION_CODE2 = "IN(印度)"
...
""")
def test_wifi_in_24g_region_connectivity(wifi_adb_device):
