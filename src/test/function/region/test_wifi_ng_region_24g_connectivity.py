# test_wifi_ng_region_24g_connectivity.py
import pytest
import allure
import time, os
import logging
...
""")
def test_wifi_ng_24g_region_connectivity(wifi_adb_device):
