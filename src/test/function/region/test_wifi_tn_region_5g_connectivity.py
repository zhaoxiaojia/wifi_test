...
2.For 5G: Test channels [36, 64]. Connect, verify internet, then change channel and check reconnection.
""")
def test_wifi_tn_5g_region_connectivity(wifi_adb_device):
    ...
    try:
        ...
        with allure.step("Restore AP and DUT to default"):
            ...
            logging.info("Restore AP and DUT to default")
