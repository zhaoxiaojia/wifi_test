...
2.For 5G: Test channels [36, 64, 100, 140]. Connect, verify internet, then change channel and check reconnection.
""")
def test_wifi_om_5g_region_connectivity(wifi_adb_device):
