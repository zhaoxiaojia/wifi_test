...
""")
def test_wifi_ec_24g_region_connectivity(wifi_adb_device):
    ...
    try:
        ...
        with allure.step("Configure DUT to {TEST_REGION_CODE2} Region"):
            try:
                ap_support_channel_list = test_channel_list
